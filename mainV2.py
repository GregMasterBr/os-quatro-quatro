...
def test_resultado_23():
   assert gerar_expressao(23) == "((4/4) + (4!)) - (√4)" #"((44) + (√4)) / (√4)" #"((4?*4?) / 4) - (√4)"       

def test_resultado_24():
   assert gerar_expressao(24) == "(4+4)+(4*4)"  

def test_resultado_25():
   assert gerar_expressao(25) == "(√4) - ((4/4) - (4!))"  #((4?*4?)/(√4))/((√4)))
...
def test_resultado_47():
   assert gerar_expressao(47) == "(4!) - ((4/4) - (4!))" 
